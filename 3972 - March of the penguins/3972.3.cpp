...
int cap[MAXN+1][MAXN+1], residual[MAXN+1][MAXN+1], flow[MAXN+1][MAXN+1], prev[MAXN+1], X[MAXN+1], Y[MAXN+1];
...
/*
  Hay un error en la representación g, que podría ser la causa de que esta rutina falle si se
miran las aristas salientes de g en cada iteración del BFS.
 */
